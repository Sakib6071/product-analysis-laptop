    ...
    return (
        <div className='w-3/4 mx-auto'>
            ...
            <div className='my-8'>
                ...
                <div className='my-5'>
                    <p className="question font-semibold text-2xl"> 1. What is Semantic Tag?</p>
                ...
                <div className='my-5'>
                    <p className="question font-semibold text-2xl"> 1. What is the difference between Inline,Inline Block and Block Element?</p>
